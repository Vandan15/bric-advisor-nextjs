                ...
                <div className="col-lg-6">
                  <div className="single-faq2">
                    ...
                    <p>
                      ...
                      approximately 20 businesses over the past 45 years.Some of
                      my businesses made millions, some of them broke even. But
                      - I never lost a dime on a single one.
                    </p>
                  </div>
                  <div className="single-faq2">
                ...
                <div className="row align-items-center">
                  <div className="col-md-6">
                    <div className="heading4 inner-heading no-margin-heading">
                      <h4 className="font-f-3 weight-700">
                        Have more questions?
                      </h4>
                      <p>
                        If you’re a business with a large payments volume or
                        unique business model, reach out to discuss alternive
                        pricing options.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-6 text-md-right">
                    <Link href="#" className="theme-btn-11">
                      Get In Touch
                    </Link>
                  </div>
                </div>
